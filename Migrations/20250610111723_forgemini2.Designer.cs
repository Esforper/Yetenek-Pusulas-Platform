...
namespace YetenekPusulasi.Migrations
{
    ...
    [Migration("20250610111723_forgemini2")]
    partial class forgemini2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YetenekPusulasi.Core.Entities.AnalysisResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.PrimitiveCollection<string>("DetectedSkills")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("YetenekPusulasi.Core.Entities.Scenario", b =>
                {
                    ...
                    b.Property<bool>("WasInitialPromptAIGenerated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("YetenekPusulasi.Core.Entities.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YetenekPusulasi.Core.Entities.AnalysisResult", b =>
                {
                    b.HasOne("YetenekPusulasi.Core.Entities.StudentAnswer", "StudentAnswer")
                        .WithOne("AnalysisResult")
                        .HasForeignKey("YetenekPusulasi.Core.Entities.AnalysisResult", "StudentAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("YetenekPusulasi.Core.Entities.StudentAnswer", b =>
                {
                    b.HasOne("YetenekPusulasi.Core.Entities.Scenario", "Scenario")
                        .WithMany()
